...
const ProductCard = ({ product }: { product: TProduct }) => {
  ...
  return (
    <div className="group rounded-sm border border-gray-200 hover:shadow-[0px_4px_41px_6px_rgba(0,_0,_0,_0.1)] transition-all duration-500 overflow-hidden">
      {/* IMAGE */}
      ...
      <div className="p-5">
        ...
        <div className="flex justify-center space-x-3 mt-5 opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 ease-in-out">
          <button className="size-10 flex justify-center items-center rounded-full bg-slate-200 hover:bg-[#86a628] hover:text-white transition">
